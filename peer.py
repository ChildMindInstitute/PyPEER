...
compute_icc(predicted_x, x_targets)
...
plt.title('Eye mask comparison - sub-5343770')
plt.plot(time_series, x_targets, '.-', color='k', label='Fixations')
plt.plot(time_series, p1, '.-', color='b', label='90th%')
plt.plot(time_series, p3, '.-', color='r', label='50th%')
plt.plot(time_series, p5, '.-', color='g', label='25th%')
plt.plot(time_series, p7, '.-', color='m', label='10th%')
plt.plot(time_series, p9, '.-', color='y', label='05th%')
plt.legend()
plt.subplot(2, 1, 2)
plt.ylabel('Vertical position')
plt.xlabel('TR')
plt.plot(time_series, y_targets, '.-', color='k', label='Fixations')
plt.plot(time_series, p2, '.-', color='b', label='90th%')
plt.plot(time_series, p4, '.-', color='r', label='50th%')
plt.plot(time_series, p6, '.-', color='g', label='25th%')
plt.plot(time_series, p8, '.-', color='m', label='10th%')
plt.plot(time_series, p10, '.-', color='y', label='05th%')
plt.legend()
plt.show()
...
# #############################################################################
# Compare eye masks for a given subject

for item in os.listdir('/data2/Projects/Jake/eye_masks'):
for item in ['x_coef_map_eyes_1.nii.gz', 'x_coef_map_eyes_5.nii.gz', 'x_coef_map_eyes_10.nii.gz']:

    eye_mask = nib.load('/data2/Projects/Jake/eye_masks/' + str(item)).get_data()
